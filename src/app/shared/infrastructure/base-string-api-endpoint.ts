...
import { BaseStringAssembler } from './base-string-assembler';

/**
 * Base API endpoint for entities with string IDs
 * @template TEntity - Domain entity type (with string ID)
 * @template TResponse - API response type
 * @template TAssembler - Assembler type for conversions
 */
export abstract class BaseStringApiEndpoint<
  TEntity extends BaseStringEntity,
  TResponse extends BaseResponse,
  TAssembler extends BaseStringAssembler<TEntity, TResponse>
> {
   ...
   * @returns Observable of updated entity
   */
  patch(partialEntity: Partial<TEntity>, id: string): Observable<TEntity> {
