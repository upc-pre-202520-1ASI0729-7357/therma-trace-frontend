...
/**
 * Base assembler for converting between domain entities and API responses
 * Implements the Anti-Corruption Layer pattern
 */
export abstract class BaseAssembler<TEntity extends BaseEntity, TResponse extends BaseResponse> {
  /**
